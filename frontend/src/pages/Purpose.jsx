  ...
  return (
    <div>
      ...
      <p>
        ...
        stored locally in the browser and can be found in the favorites page.
      </p>
      <p>
        The currently most popular movies are displayed on the front page of the
        website where you can also see their public rating and have the option
        to watch their trailers.
      </p>
      <p>
